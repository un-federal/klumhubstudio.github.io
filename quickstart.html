	...
	<div class="banner-con-container darkmode-header">
		...
		<div class='banner-con-title fade-up-onstart'>
			...
			<div class="banner-tx2-title fade-up-onstart">
				<p>
					 Получи поддержку и проконсультируйся
				</p>
			</div>
		</div>
	</div>
			...
			<div class="container-con-block darkmode-block">
				...
				<div class="container-con-wrapper">
					...
					<div class="container-tx2-block darkmode-txt">
						<p>
							 Для общения с коллективом страны и получения поддержки, тебе нужно вступить в наш <a href="https://discord.gg/8PtkxCrpDD">Discord-сервер</a>. В специальном канале <a href="https://discord.gg/8PtkxCrpDD">#консультация</a> ты можешь задать любой вопрос, касаемо страны и общества. В дискорд-сообществе ты сможешь не выходя из дома получить визу и гражданство, написать заявление в прокуратуру и записаться на прием к врачу, узнать о пробках в стране и объявить о пропавших вещах и найти владельца; и много чего другого полезного!
						</p>
					</div>
				</div>
			</div>
...
<div class="spec-con-title spec-max"><h2>Рекомендация</h2></div>
<div class="spec-con-desc"><h3>Вести себя в сообществе аккуратно и культурно, не использовать <br> ликсицизм и оскорбления. Помогать другим!</br></h3></div>
<div class="spec-con-divider darkmode-divider"></div></div>
	
<div class="spec-con-min darkmode-txt">
<div class="spec-con-title spec-min"><h2>Как не нужно делать</h2></div>
	<div class="spec-con-desc"><h3>Не писать ложные жалобы и фейковые заявки, не пытаться кого-то взломать, нельзя угрожать и кого-то оскорблять, клевета и обходы блокировок - запрещены. За нарушение этих правил вы можете нести уголовную ответственность!</h3></div>
	<div class="spec-con-divider darkmode-divider">
		...
		<div class="container-con-block darkmode-block">
				...
				<div class="container-con-wrapper">
					...
					<div class="container-tx2-block darkmode-txt">
						<p>
							 Вы можете прямо сейчас подать заявку на любую интересующую вас работу, заполнив небольшую анкету в нашем <a href="https://discord.gg/rQ73bp3aTB">Discord-сервере</a>! В специальном канале <a href="https://discord.gg/rQ73bp3aTB">#работа</a> вам ответят, есть ли вакансии, и, подходите ли вы по указанной вами информации о вас по следующей заявке! <br> Но не следует забывать, что для любой работы необходимо получить образование и то, что, если вы гражданин страны Делфтии, то у вас больше шансов получить трудоустройство, меньше - если вы не имеете гражданство или вы гражданин Дэнграда. 
						</p>
					</div>
				</div>
			</div>
			<div class="container-con-block darkmode-block">
				...
				<div class="container-con-wrapper">
					<div class="container-tx1-block darkmode-txt">
						...
						<h2>Как написать заявление в прокуратуру?</h2>
					</div>
					<div class="container-tx2-block darkmode-txt">
						<p>
							 Вы можете подать заявление в прокуратуру в нашем <a href="https://discord.gg/2wwBxthXQ2">Discord-сервере</a>! В специальном канале <a href="https://discord.gg/2wwBxthXQ2">#заявление-в-прокуратуру</a>. Дело которое будет рассматривать непосредственно сама прокуратура. Вам нужно заполнить форму заявления по данному образцу. Обратите внимание, подача заявления не по форме рассматриваться не будет!
						</p>
					</div>
				</div>
			</div>
			<div class="container-con-block darkmode-block">
				...
				<div class="container-con-wrapper">
					<div class="container-tx1-block darkmode-txt">
						...
						<h2>Как подать жалобу на нарушителей закона в милицию?</h2>
					</div>
					<div class="container-tx2-block darkmode-txt">
						<p>
							 Вы можете обратиться в милицию в нашем <a href="https://discord.gg/BGUExqN82e">Discord-сервере</a>! В специальном канале <a href="https://discord.gg/BGUExqN82e">#заявление-в-милицию</a>. Вам нужно заполнить форму заявления по данному образцу. Обратите внимание, подача заявления не по форме рассматриваться не будет!
						</p>
					</div>
				</div>
			</div>
			<div class="container-con-block darkmode-block">
				...
				<div class="container-con-wrapper">
					<div class="container-tx1-block darkmode-txt">
						...
						<h2>Как обратиться в суд?</h2>
					</div>
					<div class="container-tx2-block darkmode-txt">
						<p>
							 Вы можете написать заявление в суд в нашем <a href="https://discord.gg/BGUExqN82e">Discord-сервере</a>! В специальном канале <a href="https://discord.gg/BGUExqN82e">#заявление-в-суд</a>. Вам нужно заполнить форму заявления по данному образцу. Так же допустимы подачи апелляции на суд, обжалование или опратистовование приговора. Обратите внимание, подача заявления не по форме рассматриваться не будет!
						</p>
					</div>
				</div>
			</div>
