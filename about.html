		...
		<div class="page-in-container">
			<div class='splitter-con-container'>
					...
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							...
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Был принят на первом всенародном съезде в г.Рисполе 03.06.2023. <br>
									<br>
									<a href="/OK" target="_blank">Кодекс читать тут.</a>
								</p>
							</div>
						</div>
					</div>
				...
				<div class='splitter-img-container splitter-con-right'>
					<div class='splitter-img-wrapper' style="background: url('/img/icons/os/1800.png') no-repeat center; background-size: cover;">
					</div>
				</div>
			</div>
			<div class='splitter-con-container'>
				<div class='splitter-img-container splitter-con-left'>
					<div class='splitter-img-wrapper' style="background: url('/img/icons/os/1900.png') no-repeat center; background-size: cover;">
					</div>
				</div>
				<div class='splitter-txt-wrapper'>
					<div class='container-con-block darkmode-block'>
						<div class='container-con-wrapper'>
							...
							<div class='container-tx2-block darkmode-txt'>
								<p>
									 Будет принят на II всенародном съезде представителей. <br>
									<br>
			...
			<div class='splitter-con-container'>
				...
				<div class='splitter-img-container splitter-con-right'>
					<div class='splitter-img-wrapper' style="background: url('/img/icons/os/2000.png') no-repeat center; background-size: cover;">
					</div>
				</div>
			</div>
			<div class='splitter-con-container'>
				<div class='splitter-img-container splitter-con-left'>
					<div class='splitter-img-wrapper' style="background: url('/img/icons/os/2100.png') no-repeat center; background-size: cover;">
					</div>
				</div>
				<div class='splitter-txt-wrapper'>
					<div class='container-con-block darkmode-block'>
			...
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 Основателем всех кодексов республики Делфтии является гражданин Максим Кустов (1311) - нынешний президент республики Делфтии.
						</p>
						<br><br>
